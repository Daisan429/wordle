...
import 'package:wordle_it_edition/constants/colors.dart';
...
class _TileState extends State<Tile> with SingleTickerProviderStateMixin {
  ...
  @override
  void initState() {
    _animationController = AnimationController(duration: const Duration(milliseconds: 650), vsync: this);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Consumer<Controller>(
      builder: (_, notifier, __) {
        ...
        Future.delayed(Duration(milliseconds: 350 * delay),(){
          if(mounted){
